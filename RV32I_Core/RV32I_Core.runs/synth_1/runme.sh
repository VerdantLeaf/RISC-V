...
HD_PWD='C:/Users/kyle3/Documents/VivadoProjects/RISC-V/RV32I_Core/RV32I_Core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log if_stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source if_stage.tcl
